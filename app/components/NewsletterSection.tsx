    ...
    <section className="py-16 bg-blue-900 text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mb-8">
            Subscribe to our newsletter for the latest updates on Quantum SEC,
          ...
          >
            <input
              ...
              className="px-4 py-3 rounded-lg flex-grow max-w-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={email}
          ...
          <p className="text-sm text-blue-300">
            ...
            information will be processed in accordance with HCISS Co.'s Privacy
            Policy.
          </p>
